...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CustomAppBar(text: "Profile", hasBack: true, child: ProfileButtons()),
        SizedBox(height: 30.h),
        Text("Profile", style: AppTextStyles.cns32),
        SizedBox(height: 20.h),
        SizedBox(width: 120.r, height: 120.r, child: Placeholder()),
        SizedBox(height: 16.h),
        Text("Max Abramchuk", style: AppTextStyles.cns20),
        SizedBox(height: 20.h),
        CustomButton2(
          text: "edit profile",
          width: 178.w,
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text("32", style: AppTextStyles.cns40),
                    ...
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text("7 bets - Socer ", style: AppTextStyles.cns10),
                        SizedBox(height: 7.h),
                        Text("7 bets - Socer ", style: AppTextStyles.cns10),
                        SizedBox(height: 7.h),
                        Text("7 bets - Socer ", style: AppTextStyles.cns10),
